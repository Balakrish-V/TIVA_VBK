...
void I2C3_Init(void);
void I2C3_Write_Multiple(int slave_address, char slave_memory_address,
                         int bytes_count, char *data);
void I2C3_read_Multiple(int slave_address, char slave_memory_address,
                        int bytes_count, char *data);
...
int main(void)
{
    ...
    uart0_config();
    I2C3_Init();
    I2C3_Write_Multiple(0x68, 0x07, 1, "58");
    while (1)
    {
